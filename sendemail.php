    ...
    <div class="page" style="opacity: 1;">
        ...
        <header class="header-top" dir="rtl">
            <div class="container">
                ...
                <!-- .header-top__call -->
                <div class="header-top__call" dir="rtl">
                    ...
                    <!-- header-top__call-item -->
                    <div class="header-top__call-item" dir="rtl">
        ...
        <header class="header-middle header-middle_white-transparent" dir="rtl">
            <div class="container">
                ...
                <div class="navbar">
                    ...
                    <div class="navbar__right">
                        <ul>
                            ...
                            <li>
                                <a href="https://www.instagram.com/dr.emanelkeshk" target="_blank"><i
                            ...
                            <?php
                              ...
                              if (!empty($_POST)){
                                  ...
                                  if(!preg_match($regex, $_POST['email'])){
                                      ...
                                      mail($email,"دكتور إيمان الكشك",$message,"From: {$_POST["name"]} <{$_POST["email"]}>");
        ...
        <footer class="footer">
            ...
            <div class="footer__bottom">
                <p>جميع الحقوق محفوظة &copy; 2021 | تصميم <a target="_blank" href="https://rehany.site">الريحاني</a></p>
            </div>
